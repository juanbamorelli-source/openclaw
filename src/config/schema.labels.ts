...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.sessions.history.includeToolsMaxBytes": "Session History Tool-Inclusive Max Bytes",
  "tools.sessions.history.toolResultMaxChars": "Session History Tool Result Max Chars",
