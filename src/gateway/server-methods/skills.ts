...
import {
  ...
  validateSkillsProposalMergeParams,
...
export const skillsHandlers: GatewayRequestHandlers = {
  ...
  "skills.proposals.merge": async ({ params, respond, context }) => {
    await runSkillsProposalWorkspaceHandler({
      method: "skills.proposals.merge",
      rawParams: params,
      respond,
      context,
      validate: validateSkillsProposalMergeParams,
      run: (parsedParams, resolved) =>
        proposeMergeSkill({
          workspaceDir: resolved.workspaceDir,
          config: resolved.cfg,
          agentId: resolved.agentId,
          targetName: parsedParams.targetName,
          targetDescription: parsedParams.targetDescription,
          sourceSkillNames: parsedParams.sourceSkillNames,
          content: parsedParams.content,
          supportFiles: parsedParams.supportFiles,
          createdBy: "gateway",
          goal: parsedParams.goal,
